...
# Below command which.max returns the index of max Tcollection column , "Movie " value of that
# row is fetched:
...
# Max command is applied to columns from 4-7 and we ensure that NA values are ignored.
